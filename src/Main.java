    ...
    public static void main(String[] args) {
        ...
        while (sobrevivente.estaVivo()) {
            ...
            if (vasculharAmbiente == 1) {
                sobrevivente.vasculharAmbiente(random);
                if (!sobrevivente.estaVivo()) {
                    System.out.println("Você morreu durante a busca! FIM DE JOGO.");
                    return;
                }
            }
            ...
            System.out.println();
            String msgAcao = "Digite 1 para ATACAR, 2 para CORRER ou 3 para PASSAR FURTIVAMENTE.";
            System.out.println(msgAcao);
            ...
            while (true) {
                if (acao == 1) {
                    ...
                    System.out.println("Comando inválido. " + msgAcao);
